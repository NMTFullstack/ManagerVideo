export const API_LIST_BLOG_TV = "/api/qlc/videoai/getListBlogTimViec";
export const API_LIST_BLOG_WORK = "/api/qlc/videoai/getListBlogWork247";
...
export const UPLOAD_TOKEN_FB = "api/qlc/videoai/getTokenFacebook";
